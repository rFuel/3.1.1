...
public class GuiReceiver {
    ...
    private static void BuildCodes() {
        ...
        int nbrvals;
        String hCodes = tempGM.ReadDiskRecord(NamedCommon.BaseCamp + "/conf/http-return-codes.csv");
        if (hCodes.equals("<<ERROR>>")) {
            System.out.println("Please load "+NamedCommon.BaseCamp + "/conf/http-return-codes.csv");
            System.exit(0);
        }
        if (!hCodes.equals("")) {
    ...
    private GuiReceiver() throws Exception {
        ...
        com.SetBasecamp(NamedCommon.BaseCamp);
    ...
    private void SecureProcess() throws Exception {
        ...
        gm.uSendMessage("Starting http://" + com.getHost() + ":" + com.getPort() + chkPath );
...
//                .addHttpsListener(com.getPort(), com.getHost(), sslContext)
                .addHttpListener(com.getPort(), com.getHost())
